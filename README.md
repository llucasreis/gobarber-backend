...
- O prestador deve recebe uma notificação sempre que houver um novo agendamento;
...
- Os agendamentos devem estar disponíveis entre 8h às 18h (Primeiro às 8hr, último às 17hr);
